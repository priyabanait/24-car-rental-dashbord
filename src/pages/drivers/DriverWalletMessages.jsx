...
export default function DriverWalletMessages() {
  ...
  useEffect(() => {
    async function fetchMessages() {
      setLoading(true);
      try {
        const res = await axios.get('https://24-car-rental-backend.vercel.app/api/driver-wallet-message');
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-6">Driver Wallet Messages</h1>
      {loading ? (
