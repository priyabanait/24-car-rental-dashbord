...
export default function DriversList() {
  ...
  useEffect(() => {
    ...
    async function fetchDrivers() {
      ...
      try {
        ...
        // Fallback to https://udrive-backend-1hzo.vercel.app for local development.
  ...
  const handleChangeDriverStatus = async (driverId, newStatus) => {
    try {
      const API_BASE = import.meta.env.VITE_API_BASE || 'https://udrive-backend-1hzo.vercel.app'||'http://192.168.1.57:4000';
      const token = localStorage.getItem('udriver_token');
      const res = await fetch(`${API_BASE}/api/drivers/${driverId}`, {
        method: 'PUT',
